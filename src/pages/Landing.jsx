            ...
            <div className="content-body">
                <div className="welcome-area bg-image">
                    ...
                    <div className="bottom-btn container">
                        <button disabled={isLoading} onClick={() => findSomeone()} className="btn btn-lg btn-gradient w-100 dz-flex-box btn-shadow rounded-xl">
                            Find Someone<Loader isLoading={isLoading}/>
                        </button>
